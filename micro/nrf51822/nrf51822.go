...
// // ExtractFirmware extracts the bin and dat files from the zip
...
// // ProcessRequest handles requests using the passed in PeripheralConnected function
...
// // OnPeriphDiscovered stops scanning and connects to the device once it has been discovered
